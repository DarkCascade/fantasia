import{t as e}from"./shaderStore-D-XQlhUT.js";import{g as t,q as n}from"./index-B7Qity4A.js";var r=`fibonacci`,i=`#define rcp(x) 1./x
...
totalWeight=max(totalWeight,HALF_MIN);gl_FragColor=vec4(inputColor.rgb+albedo*max(totalIrradiance/totalWeight,vec3(0.0)),1.);}`;e.ShadersStore[l]||(e.ShadersStore[l]=u);var d=[n,a,t,c];for(let t of d)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var f={name:l,shader:u};export{f as subSurfaceScatteringPixelShader};